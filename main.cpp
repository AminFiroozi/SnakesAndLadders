...
public:
    ...
    void show(vector<Player> Players) {
        ...
        for (int i = n - 1; i >= 0; i--) {
            if (i % 2 == 1) {
                for (int j = n - 1; j >= 0; j--) {
                    ...
                    if (index == 0) {
                        cout << "|  ";
                        YELLOW cout << "GO "; WHITE
                        continue;
                    }
                    else if (index == n * n - 1) {
                        cout << "| ";
                        YELLOW cout << "END "; WHITE
                        continue;
                    }
                    ...
                    for (int k = 0; k < Players.size(); k++) {
                        if (index == Players[k].CurrentSlot) {
                            if (Players[k].Symbol.length() == 1) {
                                cout << "|  ";
                                CYAN cout << Players[k].Symbol << "  "; WHITE
                            }
        ...
        for (unsigned int i = 0; i < Snakes.size(); i++) {
            for (unsigned int j = i + 1; j < Snakes.size(); j++) {
        ...
        for (unsigned int i = 0; i < Ladders.size(); i++) {
            for (unsigned int j = i + 1; j < Ladders.size(); j++) {
                if (Ladders[i].Bottem > Ladders[j].Bottem) {
                    Ladder temp = Ladders[i];
                    Ladders[i] = Ladders[j];
                    Ladders[j] = temp;
                }
            }
        ...
        for (unsigned int i = 0; i < Snakes.size(); i++) {
            ...
            if (i != Snakes.size() - 1) cout << " / ";
        }
        cout <<  endl << "Ladders: " << endl;
        for (unsigned int i = 0; i < Ladders.size(); i++) {
            cout << "(" << Ladders[i].Bottem + 1 << "-->" << Ladders[i].Top + 1 << ")";
            if (i != Ladders.size() - 1) cout << " / ";
        }
        cout << endl;
    }
...
main() {
    ...
    while (true) {
        ...
        cout << ReadyPlayers(Players) << " has registered for the game so far.\n" << endl;
        char n;
        cin >> n;
        if (n == '1') {
            addPlayer(Players);
